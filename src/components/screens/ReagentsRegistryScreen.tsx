  ...
  return (
    <div id="reagents-registry-screen" className="max-w-6xl mx-auto flex flex-col gap-6">
      <div className="flex flex-col md:flex-row md:items-start justify-between gap-4">
        ...
        <div className="flex items-center gap-3 self-start text-xs border border-white/15 bg-white/5 px-3 py-2 rounded">
      ...
      {!isConfigured ? (
        ...
        >
          ...
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-white/15 bg-white/5 text-[10px] tracking-widest text-white/70 mb-4">
            <span className="w-1.5 h-1.5 rounded-full bg-white animate-pulse"></span>
            <span>NOTHING LOADED</span>
          </div>

          <h2 className="text-xl lg:text-2xl font-semibold text-white tracking-tight mb-2">
            Reagent registry
          </h2>
          ...
          <div className="flex flex-wrap items-center justify-center gap-3 mb-8">
            <button
              ...
              disabled={isLocked}
              className="flex items-center gap-2 px-5 py-2.5 rounded bg-white text-black font-semibold text-xs tracking-wider uppercase hover:bg-white/90 transition-all disabled:opacity-35 disabled:cursor-not-allowed shadow-lg"
            >
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-white/10 pb-4">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                onClick={onOpenAddModal}
              disabled={isLocked}
                className="flex items-center gap-1.5 px-3 py-1.5 rounded bg-white text-black font-semibold text-xs hover:bg-white/90 transition-all disabled:opacity-35 disabled:cursor-not-allowed"
              >
              ...
              <button
                type="button"
                onClick={onOpenImportModal}
                className="flex items-center gap-1.5 px-3 py-1.5 rounded border border-white/20 bg-white/5 hover:bg-white/15 text-white text-xs transition-all"
              >
            ...
            {filteredReagents.map((reagent) => (
              ...
              >
                <div className="flex flex-col gap-1.5">
                  ...
                  <div className="font-semibold text-white text-xs group-hover:text-white">
                    {reagent.name}
                  </div>
      ...
      {selectedReagent && (
        <div className="glass-panel-elevated rounded-lg p-5 border border-white/25 flex flex-col gap-3 text-xs animate-in fade-in">
          ...
          {selectedReagent.description && (
            <div className="text-[11px] text-white/60">{selectedReagent.description}</div>
          )}
        </div>
      )}
          ...
          >
            <div className="flex flex-col gap-4">
              <div className="flex items-center justify-between">
                ...
                <span className="text-[9px] tracking-wider text-white/40 uppercase border border-white/10 px-2 py-0.5 rounded bg-white/[0.02]">
                  {isConfigured ? `${reagents.length} LOADED` : 'EMPTY'}
                </span>
              </div>

              <div className="flex flex-col gap-1">
                <h3 className="text-sm font-semibold text-white tracking-tight">What is loaded</h3>
            ...
            <div className="flex items-center justify-between text-[11px] text-white/60 border-t border-white/10 pt-3">
